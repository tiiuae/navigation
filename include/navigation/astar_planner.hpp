...
enum TreeValue { OCCUPIED = 0, FREE = 1 };
...
struct LeafComparator {
  bool operator()(const std::pair<octomap::OcTree::iterator, double> &l1,
...
public:
  AstarPlanner(double safe_obstacle_distance, double euclidean_distance_cutoff,
               double planning_tree_resolution, double distance_penalty,
               double greedy_penalty, double vertical_penalty,
               bool unknown_is_occupied, float navigation_tolerance,
...
public:
  ...
  findPath(const octomap::point3d &start, const octomap::point3d &goal,
  ...
  postprocessPath(const std::vector<octomap::point3d> &waypoints);
   ...
   */
  static double distEuclidean(const octomap::point3d &p1,
   ...
   * @return Euclidean distance in meters
   */
  static double distEuclidean(const octomap::OcTreeKey &k1,
                              const octomap::OcTreeKey &k2,
                              octomap::OcTree &tree);

  static double distPenalizeVertical(const octomap::point3d &p1,
                                     const octomap::point3d &p2,
                                     double vertical_penalty);

  static double distPenalizeVertical(const octomap::OcTreeKey &k1,
                                     const octomap::OcTreeKey &k2,
                                     octomap::OcTree &tree,
                                     double vertical_penalty);

  void generatePlanningTree(std::shared_ptr<octomap::OcTree> mapping_tree,
  ...
  octomap::point3d nearestFreeCoord(const octomap::point3d &p,
                                    const octomap::point3d &uav_pos);

  std::pair<octomap::point3d, bool>
  generateTemporaryGoal(const octomap::point3d &start,
                        const octomap::point3d &goal);

private:
  const std::vector<octomap::point3d> EXPANSION_DIRECTIONS = {
   ...
   * finest resolution)
   */
  double getExpansionDepth(const octomap::OcTreeKey &key,
                           octomap::OcTree &tree);
   ...
   */
  octomap::OcTreeKey expand(const octomap::OcTreeKey &key,
  ...
  bool freeStraightPath(const octomap::point3d p1, const octomap::point3d p2,
                        double max_distance_threshold = 1e6);
   ...
   */
  std::vector<octomap::OcTreeKey> backtrackPathKeys(
      const Expansion &start, const Expansion &end,
   ...
   */
  std::vector<octomap::point3d>
  keysToCoords(std::vector<octomap::OcTreeKey> keys, octomap::OcTree &tree);
   ...
   */
  DynamicEDTOctomap
  euclideanDistanceTransform(std::shared_ptr<octomap::OcTree> tree);
};
